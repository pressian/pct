...
<div class="subnavbar">
  <div class="subnavbar-inner">
    <div class="container">
      <ul class="mainnav">
        <li class="active"><a href="javascript:dashboard()"><i class="icon-dashboard"></i><span>Dashboard</span> </a> </li>
        <li class="dropdown"><a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown"><i class="icon-th-list"></i><span>Boards</span> <b class="caret"></b></a> 
			<ul class="dropdown-menu">
          		<li><a href="newboard.html">Make a new bulletin board</a></li>
  ...
  <div class="extra-inner">
    <div class="container">
      <div class="row">
                    <div class="span3">
                        <h4>
                            About Pressian Community Tool Project</h4>
                        <ul>
                            <li><a href="javascript:;">xxxxxx.com</a></li>
                    ...
                    <div class="span3">
                        <h4>
                            About Pressian</h4>
                        <ul>
                            <li><a href="javascript:;">Pressian News</a></li>
                            <li><a href="javascript:;">Pressian Community</a></li>
                        </ul>
                    </div>
                    <!-- /span3 -->
                    <div class="span3">
